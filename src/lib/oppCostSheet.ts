...
export const OPP_SALARIES = [
  { role: 'Специалист по подбору персонала', salary: 220000 },
  { role: 'Руководитель подразделения (интервью)', salary: 700000 },
  { role: 'Служба безопасности', salary: 250000 },
...
const ROWS: CostRow[] = [
  {
    kind: 'Прямые',
    stage: 'Подбор',
    name: 'Доступ к базе резюме и реклама вакансии',
    amount: 5196,
    comment: 'Подписка на работные сайты и продвижение объявления по фактическим расходам',
  },
  {
    kind: 'Прямые',
    stage: 'Подбор',
  ...
  },
  {
    kind: 'Косвенные',
    stage: 'Подбор',
    name: 'Программный комплекс E-Staff',
    salary: 900000,
    hours: 1,
    comment: 'Общая стоимость комплекса 900 000 ₽, в расчёте на одного кандидата — 1 час работы',
  },
  {
    kind: 'Косвенные',
    stage: 'Прием',
...
export function addOppCostSheet(wb: ExcelJS.Workbook) {
  ...
  const sub = ws.addRow([
    'Собственный подбор. Услуги кадровых агентств, аутсорсинга и реферальные выплаты в расчёт не входят. Оборудование рабочего места, затраты на увольнение, обучение и адаптацию считаются отдельно.',
  ]);
