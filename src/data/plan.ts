  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        what: 'На первые 3 месяца за каждым новым сотрудником и линейным специалистом закрепляется наставник с доплатой за результат — сотрудник дошёл до конца испытательного срока.',
        owner: 'Руководители подразделений',
