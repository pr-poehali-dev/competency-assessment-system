    ...
    tasks: [
      {
        ...
        what: 'Три анкеты под разные типы увольнения: по инициативе руководства, нежелательный уход ценного сотрудника и естественные причины. Тип определяется до разговора вместе с руководителем, анкета заполняется при расчёте, до выдачи документов.',
        owner: 'Отдел кадров',
