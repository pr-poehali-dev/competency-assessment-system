...
export const EFIR_PAID_TOTAL = (EFIR_PAY.paid2025 ?? 0) + (EFIR_PAY.paid2026 ?? 0);
export const EFIR_PAY_SHARE = (EFIR_PAID_TOTAL / PAID_TOTAL) * 100;

export const EFIR_COST_2025 = Math.round((EFIR_PAY.paid2025 ?? 0) / EFIR_PAY.hired2025);
export const EFIR_COST_2026 = Math.round((EFIR_PAY.paid2026 ?? 0) / EFIR_PAY.hired2026);
