...
const STEPS = [
  { n: '1', t: 'Выбор профессии', d: 'Кандидат указывает профессию из 29 доступных' },
  { n: '2', t: 'Заполнение ФИО', d: 'Регистрация участника тестирования' },
  { n: '3', t: 'Формирование вопросов', d: 'Рандомный порядок вопросов из базы' },
  { n: '4', t: 'Открытие теста', d: 'Запуск процедуры оценки' },
  { n: '5', t: 'Тест компетенций', d: '5 вопросов по профессиональным навыкам' },
  { n: '6', t: 'Техника безопасности', d: '5 вопросов на знание ТБ' },
  { n: '7', t: 'Подсчёт результатов', d: 'Проходной балл — не менее 7 из 10' },
  { n: '8', t: 'Оформление', d: 'Результаты подшиваются в личное дело' },
  { n: '9', t: 'Сводная ведомость', d: 'Накопительный учёт по профессиям' },
];
