...
const actions: {
  ...
  },
  {
    ...
    action:
      'Выделить подразделения-лидеры по таким уходам, проверить фактические переработки и график работы, скорректировать нормативы нагрузки.',
  ...
  },
  {
    ...
    action:
      'Проверять на входе профильные навыки под конкретную задачу, закрепить наставника на первые 3 месяца и контрольные точки на 2-й, 6-й и 10-й неделе.',
  ...
  },
  {
    ...
    problem: `${g('commute').total} человек ушли из-за расположения офиса или нашли работу ближе к дому. Это выясняется одним вопросом до найма.`,
    action:
      'Добавить в анкету кандидата фактическое время в пути и способ добраться; при пути дольше 1,5 часов — обсуждать риск сразу или предлагать другой офис либо гибридный формат.',
