        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-700 leading-relaxed mt-2">
              У {EFIR_TERM.short} стоимость подбора — фиксированная сумма от 157 500 до 346 500 ₽ за человека. При 14
              наймах, закончившихся уходом в первые три месяца, речь идёт о значительной сумме, которую агентство
              обязано отработать заменой. Ключевой вопрос — фиксируются ли эти обращения и укладывается ли компания в
