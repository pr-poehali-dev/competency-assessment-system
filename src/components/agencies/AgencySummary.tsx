...
export default function AgencySummary() {
  ...
  const findings = [
    ...
    },
    {
      ...
      text: `Гарантия замены в договоре есть — нужно вести учёт её исполнения по каждому из ${AG_FIRED_2026} случаев. Дополнительно: подключить второго подрядчика для страховки и точнее описывать условия работы на собеседовании.`,
    },
  ];
